...
``` python
# Комменатрий. Тут они начинаются с символа #
...
``` python
# Имеется и представление в различных системах счистления:
x = 0b101   # 5
y = 0x0a    # 10
z = x + y   # 15
...
### All и Any
Есть еще две интеренсых функции для работы с массивами. Используя их можно выполнить проверки значений внутри массива:
``` python
