...
``` python
# Задание №1: Попробуйте написать функцию для изменения основных параметров изображения:
# 1. Контрастности
# 2. Насыщенности
# 3. Яркости
```
...
![](https://img.shields.io/badge/Задача%202-red) Исправление баланса белого.
...
Разработайте функцию поворота изображения на заданный угол (0, 90, 180, 270)
